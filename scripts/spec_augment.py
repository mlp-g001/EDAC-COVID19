...
if __name__ == '__main__':    
    wavs_signal_augmented = "./coughvid-clean-silence-removed/augmented/"
    augmentedData = "./coughvid-clean-silence-removed/augmented_melspectrogram/"
    labels_mels_signal_augmented = "./coughvid-clean-silence-removed/labels.csv"
